...
//std::list<std::string> Engine::GetBestMove(Board board) {
...
//    m_NodesChecked = 0;
//
//    for(int depth = 1; depth < c_SearchDepth; depth++) {
//        float eval = 0;
//        auto moves = SearchMove(board, depth, best_moves, eval);
...
//        if((clock() - start_time) / CLOCKS_PER_SEC > c_MaxSearchTime || std::abs(eval) > 99 || legalMoves.size() == 1) {
//            break;
//        }
//    }
//
//    std::cout << "Nodes Checked: " << m_NodesChecked << std::endl;
//
//    return best_moves;
//}
//
//std::list<std::string> Engine::SearchMove(Board board, int depth, std::list<std::string> check_moves, float &final_eval) {
//    std::list<std::string> best_moves;
//
...
//}
//
//void Engine::AddPriorityMoves(Board board, std::list<Move> &priorities) {
...
//        }
//
//        if (board.Enemy(move.toSquare)) {
//            priorities.push_back(move);
//            continue;
//        }
//
//        std::swap(board.board[move.fromSquare], board.board[move.toSquare]);
//
//        board.turn = !board.turn;
//
//        if (board.RaycastReflect(board.FindKing(), move.toSquare)) {
//            priorities.push_back(move);
//        }
//
//        board.turn = !board.turn;
...
//}
//
//float Engine::EvaluatePosition(Board board, int depth) {
...
//    }
//
//    return MaterialDifference(board);
//}
//
//float Engine::MaterialDifference(Board board) {
